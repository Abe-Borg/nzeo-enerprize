...
urlpatterns = [
    ...
    path('update-equipment-coordinates/', views.update_equipment_coordinates, name='update_equipment_coordinates'),
    path('update-building-coordinates/', views.update_building_coordinates, name='update_building_coordinates'),
]